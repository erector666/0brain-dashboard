...
export const AGENTS: AgentConfig[] = [
  ...
  { id: "lucifer", name: "Lucifer", workspaceId: "agent-main", family: "OpenClaw", provider: "ob1-agent-memory", expected: true, avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Lucifer" },
  { id: "dean", name: "Dean", workspaceId: "agent-dean", family: "OpenClaw", provider: "ob1-agent-memory", expected: true, avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Dean" },
